...
String imagePath= properties.getProperty( "img.imagePath" );
String imageRequestPath=properties.getProperty( "img.requestPath" );
...
up.setSavePath(imagePath+ dir );
up.setRequestPath(imageRequestPath+dir);
String[] fileType = {".gif" , ".png" , ".jpg" , ".jpeg" , ".bmp"};
up.setAllowFiles(fileType);
//up.setMaxSize(500 * 1024); //单位KB
up.upload();
System.out.println(up.getRequestPath());
response.getWriter().print("{'original':'"+up.getOriginalName()+"','url':'"+up.getRequestPath()+"','title':'"+up.getTitle()+"','state':'"+up.getState()+"'}");
%>
