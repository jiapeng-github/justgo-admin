package com.justgo.admin.dto.ServiceSite;
 ...
 * 系统字典数据表DTO
 */
public class SysDictionaryDataDTO extends SysDictionaryData {

    private static final long serialVersionUID = -4188985074226889396L;
